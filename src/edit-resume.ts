...
function loadStoredData(): void {
    ...
    (document.getElementById('skill-4') as HTMLInputElement).value = storedData.skills?.[2]?.skill || '';
    (document.getElementById('skill-level-4') as HTMLInputElement).value = storedData.skills?.[2]?.level || ''; (document.getElementById('skill-3') as HTMLInputElement).value = storedData.skills?.[2]?.skill || '';
    (document.getElementById('skill-5') as HTMLInputElement).value = storedData.skills?.[2]?.skill || '';
    (document.getElementById('skill-level-5') as HTMLInputElement).value = storedData.skills?.[2]?.level || '';
...
document.getElementById('editResumeForm')?.addEventListener('submit', function (event) {
    ...
    const updatedData: ResumeData = {
        ...
        skills: [
            ...
            {
                skill: (document.getElementById('skill-4') as HTMLInputElement).value,
                level: (document.getElementById('skill-level-4') as HTMLInputElement).value,
            },
            {
                skill: (document.getElementById('skill-5') as HTMLInputElement).value,
                level: (document.getElementById('skill-level-5') as HTMLInputElement).value,
            },
        ],
        firstName: "",
        lastName: "",
